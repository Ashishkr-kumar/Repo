...
/**
 * <p>Java class for SampleProducts_c complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SampleProducts_c">
 *   &lt;complexContent>
 ...
 *         &lt;element name="SampleProductName_Id_c" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="SampleProductName_c" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 ...
 *         &lt;element name="DeliveredDate_c" type="{http://xmlns.oracle.com/adf/svc/types/}dateTime-Timestamp" minOccurs="0"/>
 *         &lt;element name="ReturnStatus_c" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="Status_c" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="InStock_c" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SampleProducts_c", propOrder = {
    "id",
    "recordName",
    "createdBy",
    "creationDate",
...
public class SampleProductsC {
    ...
    @XmlElementRef(name = "SampleProductName_Id_c", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/personService/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> sampleProductNameIdC;
    @XmlElementRef(name = "SampleProductName_c", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/personService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sampleProductNameC;
    @XmlElementRef(name = "Quantity_c", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/personService/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> quantityC;
    @XmlElementRef(name = "Comments_c", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/personService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> commentsC;
    @XmlElementRef(name = "DeliveredDate_c", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/personService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> deliveredDateC;
    @XmlElementRef(name = "ReturnStatus_c", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/personService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> returnStatusC;
    @XmlElementRef(name = "Status_c", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/personService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> statusC;
    @XmlElementRef(name = "InStock_c", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/personService/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> inStockC;
    ...
    /**
     * Gets the value of the sampleProductNameIdC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link BigDecimal }{@code >}
     *     
     */
    public JAXBElement<BigDecimal> getSampleProductNameIdC() {
        return sampleProductNameIdC;
    }

    /**
     * Sets the value of the sampleProductNameIdC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link BigDecimal }{@code >}
     *     
     */
    public void setSampleProductNameIdC(JAXBElement<BigDecimal> value) {
        this.sampleProductNameIdC = value;
    }

    /**
     * Gets the value of the sampleProductNameC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getSampleProductNameC() {
        return sampleProductNameC;
    }

    /**
     * Sets the value of the sampleProductNameC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setSampleProductNameC(JAXBElement<String> value) {
        this.sampleProductNameC = value;
    }
    ...
    /**
     * Gets the value of the deliveredDateC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link XMLGregorianCalendar }{@code >}
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getDeliveredDateC() {
        return deliveredDateC;
    }

    /**
     * Sets the value of the deliveredDateC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link XMLGregorianCalendar }{@code >}
     *     
     */
    public void setDeliveredDateC(JAXBElement<XMLGregorianCalendar> value) {
        this.deliveredDateC = value;
    }

    /**
     * Gets the value of the returnStatusC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getReturnStatusC() {
        return returnStatusC;
    }

    /**
     * Sets the value of the returnStatusC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setReturnStatusC(JAXBElement<String> value) {
        this.returnStatusC = value;
    }
    ...
    /**
     * Gets the value of the inStockC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link BigDecimal }{@code >}
     *     
     */
    public JAXBElement<BigDecimal> getInStockC() {
        return inStockC;
    }

    /**
     * Sets the value of the inStockC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link BigDecimal }{@code >}
     *     
     */
    public void setInStockC(JAXBElement<BigDecimal> value) {
        this.inStockC = value;
    }
